...
export const initD3Config = createAction('[D3] Init D3 Panel Config', props<{ d3Id: string; d3Config: IccD3Config }>());
export const loadRemoteD3Config = createAction(
  '[D3] Load Remote D3 Config',
  props<{ d3Id: string; d3Config: IccD3Config }>(),
);
...
export const loadD3ChartConfigsSuccess = createAction(
  ...
  props<{ d3Id: string; d3Config: IccD3Config; chartConfigs: IccD3ChartConfig[] }>(),
);

export const getD3Data = createAction('[D3] Get D3 Data', props<{ d3Id: string; d3Config: IccD3Config }>());
export const getD3DataSuccess = createAction(
  '[D3] Get D3 Data Success',
  props<{ d3Id: string; d3Config: IccD3Config; data: any[] }>(),
);
