import { FormatWidth, getLocaleDateFormat } from '../common/common';
import { memoize } from './memoize';
import { NumericWeekday } from './numeric-weekday';

export function setDay(date: Date, weekday: NumericWeekday) {
  return addDays(date, weekday - date.getDay());
}
...
export function toLocalStringSupportsLocales(): boolean {
  try {
